...
import { DomainModelAstNode, example, examples, getMainTreeNode, syntaxHighlighting } from "./masala-model-tools";
            ...
            <div className="justify-center self-center flex flex-col md:flex-row h-full w-full p-4">
                <div className="float-left w-full h-full flex flex-col">
                    <div className="border-solid border border-emeraldLangium bg-emeraldLangiumDarker flex items-center p-3 text-white font-mono">
                        Editor
                        <select className="ml-4 bg-emeraldLangiumDarker cursor-pointer border-0 border-b invalid:bg-emeraldLangiumABitDarker"  onChange={(e) => this.setExampleIndex(parseInt(e.target.value))}>
                            <option value="0">Ride-Sharing App (e.g., Uber, Lyft)</option>
                            <option value="1">Online Food Delivery Platform (e.g., DoorDash, UberEats)</option>
                            <option value="2">Social Media Platform (e.g., Facebook, Instagram)</option>
                            <option value="3">Video Streaming Service (e.g., Netflix, Hulu)</option>
                            <option value="4">E-commerce Platform (e.g., Amazon, eBay)</option>
                            <option value="5">Cloud Storage Service (e.g., Google Drive, Dropbox)</option>
                            <option value="6">Real-Time Chat Application (e.g., WhatsApp, Slack)</option>
                            <option value="7">Job Search Platform (e.g., LinkedIn, Indeed)</option>
                            <option value="8">Online Learning Platform (e.g., Coursera, Udemy)</option>
                            <option value="9">Online Payment System (e.g., PayPal, Stripe)</option>
                        </select>
                    </div>
                ...
                <div className="float-left w-full h-full flex flex-col" id="preview">
                    <div className="border-solid border border-emeraldLangium bg-emeraldLangiumDarker flex items-center p-3 text-white font-mono ">
                        Preview
                        <select className="ml-4 bg-emeraldLangiumDarker cursor-pointer border-0 border-b invalid:bg-emeraldLangiumABitDarker"  onChange={(e) => this.setUiIndex(parseInt(e.target.value))}>
