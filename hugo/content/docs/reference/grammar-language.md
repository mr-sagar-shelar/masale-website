...
For example, in the [Arithmetics example](https://github.com/mr-sagar-shelar/masale-website/blob/main/examples/arithmetics/src/language-server/arithmetics.langium):
```langium
AbstractDefinition:
...
The following example from the [domain model example](https://github.com/mr-sagar-shelar/masale-website/blob/main/examples/domainmodel/src/language-server/domain-model.langium) uses the `QualifiedName` data type rule to enable references to other elements using their fully qualified name.
```langium
